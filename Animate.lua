...
local animNames = { 
	idle = 	{	
				--{ id = "http://www.roblox.com/asset/?id=04436316984", weight = 1 },
				--{ id = "http://www.roblox.com/asset/?id=04436316984", weight = 1 },
				--{ id = "http://www.roblox.com/asset/?id=04436316984", weight = 9 }
			},
	walk = 	{ 	
				{ id = "http://www.roblox.com/asset/?id=913402848", weight = 10 } 
			}, 
	run = 	{
				{ id = "rbxassetid://4430469539", weight = 10 } 
			}, 
	swim = 	{
	...
	jump = 	{
				{ id = "http://www.roblox.com/asset/?id=4454405096", weight = 10 } 
			}, 
	fall = 	{
				{ id = "http://www.roblox.com/asset/?id=4454405096", weight = 10 } 
			}, 
...
local prevSprint = sprinting.Value

local sprintAnim = Instance.new("Animation")
sprintAnim.Name = "WalkAnim"
sprintAnim.AnimationId = "rbxassetid://04509100716"

local walkAnim = Instance.new("Animation")
walkAnim.Name = "WalkAnim"
walkAnim.AnimationId = "rbxassetid://4430469539"
...
local function switchToAnim(anim, animName, transitionTime, humanoid)
	...
	if (anim ~= currentAnimInstance) then
		...
		if animName == "walk" then
			local animToPlay
			if sprinting.Value then
				animToPlay = sprintAnim
			else
				animToPlay = walkAnim
			end
			
			runAnimTrack = humanoid:LoadAnimation(animToPlay)
